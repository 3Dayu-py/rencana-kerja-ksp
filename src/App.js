...
const TASKS = [
  ...
  { id:2, phase:"KSP Perbatasan", ksp:"Perbatasan", days:3,
    ...
    note:"Menggabungkan kajian existing per-WKP menjadi 1 dokumen KSP Perbatasan; harmonisasi narasi, data, dan substansi; identifikasi gap. TA Hukum & TA GIS KSP belum kontrak pada fase ini" },
  ...
  { id:5, phase:"KSP Perbatasan", ksp:"Perbatasan", days:4,
    ...
    note:"Dokumen inti: tinjauan kebijakan; gambaran umum wilayah; arahan pengembangan kawasan; rencana aksi; pemantauan & evaluasi" },
  ...
  { id:8, phase:"KSP Banten Lama", ksp:"Banten Lama", days:3,
    tags:["bl"],
  ...
  { id:9, phase:"KSP Banten Lama", ksp:"Banten Lama", days:3,
    tags:["bl"],
  ...
  { id:10, phase:"KSP Banten Lama", ksp:"Banten Lama", days:3,
    tags:["bl","koordinasi"],
    label:"Kajian Kebijakan Penataan Ruang dan Pembangunan  ·  Koordinasi TT Juni",
    pj:"TA PWK KSP, TA PWK FPR, TA Hukum",
    output:"Dokumen kajian kebijakan penataan ruang & pembangunan  |  Notulensi koordinasi TT Juni",
  ...
  { id:17, phase:"KSP Banten Lama", ksp:"Banten Lama", days:3,
    ...
    note:"Analisis keterkaitan kawasan Banten Lama dengan wilayah sekitar yang terpengaruh; dampak regional pengembangan kawasan" },
  ...
  { id:18, phase:"KSP Banten Lama", ksp:"Banten Lama", days:3,
    ...
    note:"Estimasi kebutuhan pembiayaan; identifikasi sumber (APBN, APBD, swasta); skema pendanaan pengembangan kawasan" },

  { id:19, phase:"KSP Banten Lama", ksp:"Banten Lama", days:10,
    tags:["bl","doktek"],
    ...
    note:"Dokumen inti (paling kompleks, disusun dari awal): pendahuluan; tinjauan kebijakan; gambaran umum; arahan pengembangan; rencana aksi; pemantauan & evaluasi" },

  { id:20, phase:"KSP Banten Lama", ksp:"Banten Lama", days:5,
  ...
  { id:21, phase:"KSP KP3B", ksp:"KP3B", days:4,
    ...
    label:"Survei Lapangan KSP KP3B  ·  Koordinasi TT September",
    pj:"TA PWK KSP, TA GIS FPR, TA GIS KSP, Asisten PWK",
    output:"Data primer lapangan KSP KP3B  |  Notulensi koordinasi TT September",
    note:"Survei kondisi fisik kawasan pusat pemerintahan KP3B; dokumentasi lapangan; observasi infrastruktur dan tata ruang eksisting. Koordinasi Tim Teknis September" },
  ...
  { id:25, phase:"KSP KP3B", ksp:"KP3B", days:1,
    tags:["lapbul"],
  ...
  { id:27, phase:"KSP KP3B", ksp:"KP3B", days:2,
    tags:["kp3b","gis"],
    label:"Analisis Delineasi Kawasan",
    pj:"TA PWK KSP, TA GIS FPR, TA GIS KSP",
  ...
  { id:28, phase:"KSP KP3B", ksp:"KP3B", days:4,
    tags:["kp3b","gis"],
  ...
  { id:29, phase:"KSP KP3B", ksp:"KP3B", days:1,
    tags:["lapbul","koordinasi"],
  ...
  { id:31, phase:"KSP KP3B", ksp:"KP3B", days:3,
    tags:["kp3b"],
    label:"Analisis Regional",
    pj:"TA PWK KSP, TA PWK FPR",
  ...
  { id:32, phase:"KSP KP3B", ksp:"KP3B", days:3,
    tags:["kp3b"],
    label:"Analisis Pembiayaan Pembangunan",
    pj:"TA PWK FPR, Asisten PWK",
  ...
  { id:33, phase:"KSP KP3B", ksp:"KP3B", days:10,
    tags:["kp3b","doktek"],
    label:"Penyusunan Dokumen Teknis KSP KP3B",
    pj:"TA PWK KSP, TA PWK FPR, Asisten PWK, TA GIS FPR, TA GIS KSP",
    output:"Dokumen Teknis KSP KP3B",
    note:"Dokumen inti: pendahuluan; tinjauan kebijakan; gambaran umum; arahan pengembangan kawasan; rencana aksi; pemantauan & evaluasi" },

  { id:34, phase:"KSP KP3B", ksp:"KP3B", days:7,
    tags:["kp3b","hukum"],
  ...
  { id:35, phase:"Pembahasan & Finalisasi", ksp:"Semua", days:10,
    ...
    note:"FGD & rapat koordinasi lintas sektor dengan OPD dan stakeholder untuk ke-3 Ranpergub KSP; penyempurnaan substansi berdasarkan masukan" },

  { id:36, phase:"Pembahasan & Finalisasi", ksp:"Semua", days:2,
    tags:["hukum","koordinasi"],
    label:"Konsultasi Biro Hukum KSP Perbatasan  ·  Koordinasi TT November",
    pj:"TA PWK KSP, TA Hukum",
    output:"Notulensi Biro Hukum KSP Perbatasan  |  Notulensi koordinasi TT November",
    note:"Konsultasi Biro Hukum untuk KSP Perbatasan (TA Hukum baru bergabung bulan ke-2). Koordinasi bulanan Tim Teknis PUPR (November)" },

  { id:37, phase:"Pembahasan & Finalisasi", ksp:"Semua", days:1,
    tags:["lapbul"],
  ...
  { id:38, phase:"Pembahasan & Finalisasi", ksp:"Semua", days:8,
    ...
    pj:"TA PWK KSP, TA PWK FPR, Asisten PWK",
    output:"Laporan Pendahuluan · Laporan Antara · Laporan Akhir (masing-masing 5 eks)",
    note:"Kompilasi & penyusunan seluruh dokumen pelaporan. Diserahkan di akhir kontrak" },

  { id:39, phase:"Pembahasan & Finalisasi", ksp:"Semua", days:3,
    tags:[],
    label:"Penyusunan Ringkasan Eksekutif (per KSP — 3 dokumen)",
    pj:"TA PWK KSP, TA PWK FPR",
    output:"Ringkasan Eksekutif KSP Perbatasan · KSP Banten Lama · KSP KP3B",
    note:"Executive summary per KSP memuat poin-poin kunci: nilai strategis, konsep pengembangan, dan rencana aksi masing-masing kawasan" },

  { id:40, phase:"Pembahasan & Finalisasi", ksp:"Semua", days:4,
    tags:[],
    label:"Penyusunan Jurnal",
    pj:"TA PWK KSP, TA PWK FPR",
    output:"Draft jurnal ilmiah (dari kajian KSP)",
    note:"Penyusunan 1 jurnal ilmiah berbasis kajian yang dilakukan selama pekerjaan; dapat fokus pada 1 tema kajian paling substansial" },

  { id:41, phase:"Pembahasan & Finalisasi", ksp:"Semua", days:5,
    tags:["koordinasi"],
    label:"Koordinasi TT Desember  ·  Finalisasi Seluruh Dokumen",
  ...
  { id:42, phase:"Pembahasan & Finalisasi", ksp:"Semua", days:1,
